...
export default function Home() {
  ...
  */
      ...
      return (
        <div>
          <div className={styles.description}>
            ...
            {utils.formatEther(cdBalance)} BlueEyes Tokens
            <br />
            {utils.formatEther(ethBalance)} Ether
            <br />
            {utils.formatEther(lpBalance)} BlueEyes LP tokens
          </div>
          <div>
      ...
      return (
        <div>
          ...
          >
            ...
            <option value="cryptoDevToken">BlueEyes Token</option>
          </select>
          <br />
          <div className={styles.inputDiv}>
            {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
  ...
  return (
    <div>
      <Head>
        <title>BlueEyes Exchange</title>
        <meta name="description" content="Whitelist-Dapp" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to BlueEyes Exchange!</h1>
          <div className={styles.description}>
            Exchange Ethereum &#60;&#62; BlueEyes Tokens
          </div>
          <div>
            <button
